 ...
 */
final class Version20220708132353 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket ADD category_id INT DEFAULT NULL, DROP slug');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket ADD slug VARCHAR(255) NOT NULL, DROP category_id');
    }
}
