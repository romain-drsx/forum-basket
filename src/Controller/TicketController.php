...
class TicketController extends AbstractController
{
    ...
    #[Route('/{id}', name: 'app_ticket_getId', methods: ['GET'])]
    public function getId(Ticket $ticket): Response
    {
        return $this->render('ticket/getId.html.twig', [
            'ticket' => $ticket,
        ]);
    }
    ...
    #[Route('/{id}/closed', name: 'app_ticket_closed')]
    public function closed(EntityManagerInterface $entityManager, Ticket $ticket): Response
    {
